  ...
  public projectsList: IProject[] = [
    {
      ...
      techStack: [ "Angular 16", "Typescript", "SASS", "movieDb API" ],
      alt: "Movie's logo",
      isLive: true,
      liveDemoUrl: "https://denisshtupa.github.io/movie-db-app/movie-db/new-movies",
      githubLinkRepo: "https://github.com/denisshtupa/movie-db-app"
    },
    {
      name: "Shopping cart",
      posterUrl: "assets/images/shopping_cart.png",
      techStack: [ "Angular 16", "Typescript", "SASS", "PrimeNG" ],
      alt: "Shopping cart logo",
      isLive: true,
      liveDemoUrl: "https://denisshtupa.github.io/shopping-cart-app/shopping-cart",
    ...
    // },
    {
      ...
      techStack: [ "React", "Typescript", "Context state", "SASS" ],
      alt: "Budget's logo",
      isLive: true,
      liveDemoUrl: "https://denisshtupa.github.io/budget-react-ts-app",
      githubLinkRepo: "https://github.com/denisshtupa/budget-react-ts-app"
    },
    // {
